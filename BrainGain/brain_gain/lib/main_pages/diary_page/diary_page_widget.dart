                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'With each passing day write about the patient\'s progress ',
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 7.0, 0.0),
                                            child: Text(
                                              'Today the patient made movements with the feet while listening to her favourite song.',
                                              style:
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 7.0, 0.0),
                                            child: Text(
                                              'Today the patient said the word \"fruit\" when i was eating an apple.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 7.0, 0.0),
                                          child: Text(
                                            'Pacient reacted to touch stimuli',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 7.0, 0.0),
                                            child: Text(
                                              'Today the patient moved her arm while applyign the movement patterns stimuli.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
