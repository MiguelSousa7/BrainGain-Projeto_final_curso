                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed('colors_activity');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 10.0, 5.0, 0.0),
                                            child: Text(
                                              'This activity consists in determining if the participant can identify the red circle and the green circle.',
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('music_activity');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              mainAxisAlignment: MainAxisAlignment.start,
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 10.0, 0.0, 0.0),
                                            child: Text(
                                              'This activity consists of listening into some music.',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                  .override(
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 10.0, 0.0, 0.0),
                                          child: Text(
                                            'This activity consists of touching the patient with some movement patterns.',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 10.0, 5.0, 0.0),
                                            child: Text(
                                              'This activity consists in aplying objets with diffrent temperatures to the patient.',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                  .override(
